    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="bg-gray-800 p-6 text-center">
          <h1 className="text-2xl font-bold text-blue-200">Sign In to Your Account</h1>
          <p className="text-gray-300 mt-2">Welcome back to PhotoPro</p>
        </div>
            ...
            <div>
              ...
              <div className="relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  required
                  className="block w-full pl-10 pr-10 py-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400 transition"
                  placeholder="••••••••"
                />
